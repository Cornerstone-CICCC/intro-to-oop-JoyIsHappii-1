...
Now it is time to convert the `newTask` function into a class called `Task`

- Change the newTask function into a class
- the outcome should be the same as before
